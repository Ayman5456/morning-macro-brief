...
def generate_brief(options: BriefOptions, model: str) -> BriefOutput:
    ...
    prompt = (
        ...
        "Include a diversification research watchlist section using the supplied diversification watchlist data; "
        "frame names as candidates to monitor, not direct buy recommendations. "
